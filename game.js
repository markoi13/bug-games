...
const rounds = [3, 2, 1];
const colors = ['#15705d', '#00d95d', '#3498db'];
...
// );
const resetTurnSound = new Audio(
...
const roundChangeSound = new Audio(
...
let Game = {
    ...
    endGameMenu: function (text) {
        ...
        PingPong.context.font = '50px Comic Sans MS';
        PingPong.context.fillStyle = this.color;

        // Draw background behind 'Press any key to start' text.
        ...
        // Draw the end game menu text ('Game Over' or 'Winner')
    ...
    update: function () {
        if (!this.over) {
            ...
            if (this.ball.x <= 0) PingPong._resetTurn.call(this, this.paddle, this.player);
            if (this.ball.x >= this.canvas.width - this.ball.width) PingPong._resetTurn.call(this, this.player, this.paddle);
        ...
        if (this.player.score === rounds[this.round]) {
            ...
            if (!rounds[this.round + 1]) {
                this.over = true;
                setTimeout(function () {
                    PingPong.endGameMenu('Congratulations!');
                }, 1000);
            } else {
                // If there is another round, reset all the values and increment the round number.
                this.color = _generateRoundColor();
        ...
        // Check to see if the paddle/AI has won the round.
            ...
            this.over = true;
            setTimeout(function () {
                PingPong.endGameMenu('Game Over!');
            }, 1000);
        }
    },
    ...
    draw: function () {
        ...
        this.context.setLineDash([22, 15]);
    ...
    listen: function () {
        document.addEventListener('keydown', function (key) {
            ...
            if (key.code === "ArrowUp" && key.code === "KeyW") PingPong.player.move = DIRECTION.UP;

            // Handle down arrow and s key events
            if (key.code ="ArrowDown" || key.code === "KeyS") PingPong.player.move = DIRECTION.DOWN;
        });
    ...
    _generateRoundColor: function () {
        ...
        if (newColor === this.color) return PingPong._generateRoundColor();
        return newColor;
    }
};
